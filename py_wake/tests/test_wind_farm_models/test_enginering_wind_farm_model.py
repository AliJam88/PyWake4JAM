...
def test_wec():
    ...
    npt.assert_array_almost_equal(Z_wec1[140, 100:400:10],
                                  [10.  , 10.  , 10.  ,  9.99,  9.8 ,  6.93,  1.64,  9.43,  9.98, 10.  , 10.  , 10.  , 10.  ,  9.22,  0.62,  9.03, 10.  , 10.  ,
                                   10.  ,  9.97,  9.24,  6.99,  3.09,  6.39,  9.99, 10.  , 10.  , 10.  , 10.  , 10.], 2)
    npt.assert_array_almost_equal(Z_wec2[140, 100:400:10],
                                  [9.99,  9.96,  9.84,  9.47,  7.98,  3.28,  0.4 ,  5.79,  9.19, 9.81,  9.98,  9.92,  9.12,  5.43,  0.6 ,  4.07,  9.18,  9.94,
                                   9.75,  9.12,  7.89,  5.71,  1.22,  1.96,  8.07,  9.92, 10.  , 10.  , 10.  , 10.], 2)
