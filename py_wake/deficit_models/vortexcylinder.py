...
class VortexCylinder(BlockageDeficitModel):
    ...
    def __init__(self, a0=madsen_a0, limiter=1e-3, exclude_wake=True, superpositionModel=None, rotorAvgModel=None, groundModel=None,
                 upstream_only=False):
    ...
    def calc_deficit(self, WS_ilk, D_src_il, dw_ijlk, cw_ijlk, ct_ilk, **_):
        ...
        gammat_ilk = WS_ilk * 2. * self._a0(ct_ilk)
